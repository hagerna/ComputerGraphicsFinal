...
class SkyBoxRenderer{
    ...
    */
    drawModel(model, camera, shaderData){
        ...
        gl.drawElements(model.mesh.drawmMode, model.mesh.indexCount, gl.UNSIGNED_SHORT, 0);
    ...
    */
    setUniformData(model, camera, shaderData){
        ...
        // let lightColLoc = gl.getUniformLocation(this.program, "u_pointLightColor");
        // gl.uniform3fv(lightColLoc, shaderData.lightingData.pointLightColor.toFloat32());
